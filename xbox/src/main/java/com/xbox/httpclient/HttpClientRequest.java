...
import com.xbox.httpclient.NetworkObserver;
...
/* loaded from: classes2-dex2jar.jar:com/xbox/httpclient/HttpClientRequest.class */
public class HttpClientRequest {
    ...
    public void doRequestAsync(long j) {
        OK_CLIENT.newCall(this.requestBuilder.build()).enqueue(new Callback() { // from class: com.xbox.httpclient.HttpClientRequest.1
            ...
            public void onFailure(Call call, IOException iOException) {
                ...
                OnRequestFailed(this.val$sourceCall, iOException.getClass().getCanonicalName(), stringWriter.toString(), GetAllNetworksInfo(), iOException instanceof UnknownHostException);
            }

            @Override // okhttp3.Callback
            public void onResponse(Call call, Response response) {
                OnRequestCompleted(this.val$sourceCall, new HttpClientResponse(this.val$sourceCall, response));
            }
        });
    }
    ...
    /* JADX WARN: Type inference failed for: r0v14, types: [okhttp3.RequestBody] */
